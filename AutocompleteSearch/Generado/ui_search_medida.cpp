#include "ui_search_medida.h"
#include "ui_ui_search_medida.h"
#include <QStringListModel>
ui_search_medida::ui_search_medida(QWidget *parent) :
QWidget(parent),
ui(new Ui::ui_search_medida)
{
	ui->setupUi(this);
	table_name = "e_medida";
...
void ui_search_medida::refreshTableView()
{
	QString filtro;
	bool primero = true;
...
void ui_search_medida::on_le_descripcion_editingFinished()
{
	refreshTableView();
}
ui_search_medida::~ui_search_medida()
{
	delete ui;
}
