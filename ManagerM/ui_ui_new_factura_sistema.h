...
**
** Created: Wed 15. May 15:57:52 2013
...
public:
    ...
    void setupUi(QWidget *ui_new_factura_sistema)
    {
        ...
        ui_new_factura_sistema->resize(596, 30);
        gridLayout = new QGridLayout(ui_new_factura_sistema);
        ...
        pushButton_new = new QPushButton(ui_new_factura_sistema);
        ...
        label_3->raise();
        spinBox_serie->raise();
        spinBox_numero_i->raise();
        spinBox_numero_f->raise();
    ...
    {
        ui_new_factura_sistema->setWindowTitle(QApplication::translate("ui_new_factura_sistema", "Form", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("ui_new_factura_sistema", "Serie", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("ui_new_factura_sistema", "Numero Inicio", 0, QApplication::UnicodeUTF8));
        label_3->setText(QApplication::translate("ui_new_factura_sistema", "Numero Fin", 0, QApplication::UnicodeUTF8));
