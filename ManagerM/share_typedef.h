...
//ENUM COLABORADORES
enum{COL_DNI,COL_TIENDA,COL_NOMBRES,COL_APAT,COL_AMAT,COL_DIRECCION,COL_FNAC,COL_SEXO,COL_ESTCIVIL,
     COL_CELULAR,COL_TLFONO,COL_EMAIL,COL_COMMENT,COL_HABILITADO};

//ENUM PERSONA_JURIDICA
enum{PJ_RUC,PJ_REGION,PJ_NOMBRE,PJ_DIRECCION,PJ_TLFONO,PJ_FAX,PJ_REPRESENTANTE,PJ_EMAIL,PJ_PAGWEB,
    PJ_COMENTARIO,PJ_HABILITADO};


#define MAX_VALUE_PRECIO 100000000
#define MAX_VALUE_STOCK 10000
