/********************************************************************************
** Form generated from reading UI file 'ui_new_compra_flete.ui'
**
** Created: Sat 22. Jun 16:59:17 2013
**      by: Qt User Interface Compiler version 4.8.1
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_UI_NEW_COMPRA_FLETE_H
#define UI_UI_NEW_COMPRA_FLETE_H
...
public:
    ...
    void setupUi(QWidget *ui_new_compra_flete)
    {
        if (ui_new_compra_flete->objectName().isEmpty())
            ui_new_compra_flete->setObjectName(QString::fromUtf8("ui_new_compra_flete"));
        ui_new_compra_flete->resize(660, 438);
        gridLayout_2 = new QGridLayout(ui_new_compra_flete);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        label_codigo = new QLabel(ui_new_compra_flete);
        ...
        lineEdit_codigo = new QLineEdit(ui_new_compra_flete);
        ...
        label_fecha_emision = new QLabel(ui_new_compra_flete);
        ...
        dateEdit_emision = new QDateEdit(ui_new_compra_flete);
        ...
        label_fecha_sistema = new QLabel(ui_new_compra_flete);
        ...
        dateEdit_sistema = new QDateEdit(ui_new_compra_flete);
        ...
        label_serie_numero = new QLabel(ui_new_compra_flete);
        ...
        lineEdit_serie = new QLineEdit(ui_new_compra_flete);
        ...
        label_transportista = new QLabel(ui_new_compra_flete);
        ...
        lineEdit_codigoTransportista = new QLineEdit(ui_new_compra_flete);
        ...
        line_2 = new QFrame(ui_new_compra_flete);
        ...
        lineEdit_nombreTransportista = new QLineEdit(ui_new_compra_flete);
        ...
        pushButton_buscarTransportista = new QPushButton(ui_new_compra_flete);
        ...
        line = new QFrame(ui_new_compra_flete);
        ...
        label_10 = new QLabel(ui_new_compra_flete);
        ...
        pushButton_ingresarFacturas = new QPushButton(ui_new_compra_flete);
        ...
        tableView_facturas = new QTableView(ui_new_compra_flete);
        ...
        label_11 = new QLabel(ui_new_compra_flete);
        ...
        pushButton_registrar = new QPushButton(ui_new_compra_flete);
        ...
        retranslateUi(ui_new_compra_flete);

        QMetaObject::connectSlotsByName(ui_new_compra_flete);
    } // setupUi

    void retranslateUi(QWidget *ui_new_compra_flete)
    {
        ui_new_compra_flete->setWindowTitle(QApplication::translate("ui_new_compra_flete", "Form", 0, QApplication::UnicodeUTF8));
        label_codigo->setText(QApplication::translate("ui_new_compra_flete", "C\303\263digo:", 0, QApplication::UnicodeUTF8));
        label_fecha_emision->setText(QApplication::translate("ui_new_compra_flete", "Fecha de emisi\303\263n:", 0, QApplication::UnicodeUTF8));
        label_fecha_sistema->setText(QApplication::translate("ui_new_compra_flete", "Fecha de sistema:", 0, QApplication::UnicodeUTF8));
        label_serie_numero->setText(QApplication::translate("ui_new_compra_flete", "Serie y n\303\272mero:", 0, QApplication::UnicodeUTF8));
        label_menos->setText(QApplication::translate("ui_new_compra_flete", "  -", 0, QApplication::UnicodeUTF8));
        label_transportista->setText(QApplication::translate("ui_new_compra_flete", "Transportista:", 0, QApplication::UnicodeUTF8));
        pushButton_buscarTransportista->setText(QApplication::translate("ui_new_compra_flete", "Buscar", 0, QApplication::UnicodeUTF8));
        label_10->setText(QApplication::translate("ui_new_compra_flete", "Facturas relacionadas", 0, QApplication::UnicodeUTF8));
        pushButton_ingresarFacturas->setText(QApplication::translate("ui_new_compra_flete", "Ingresar facturas", 0, QApplication::UnicodeUTF8));
        label_monto->setText(QApplication::translate("ui_new_compra_flete", "Monto:", 0, QApplication::UnicodeUTF8));
        pushButton_disgregarMonto->setText(QApplication::translate("ui_new_compra_flete", "Disgregar monto", 0, QApplication::UnicodeUTF8));
        label_11->setText(QString());
        label_subtotal->setText(QApplication::translate("ui_new_compra_flete", "Sub Total:", 0, QApplication::UnicodeUTF8));
        label_igv->setText(QApplication::translate("ui_new_compra_flete", "IGV:", 0, QApplication::UnicodeUTF8));
        label_total->setText(QApplication::translate("ui_new_compra_flete", "Total:", 0, QApplication::UnicodeUTF8));
        lineEdit_igv->setText(QApplication::translate("ui_new_compra_flete", "0.18", 0, QApplication::UnicodeUTF8));
        pushButton_registrar->setText(QApplication::translate("ui_new_compra_flete", "Registrar", 0, QApplication::UnicodeUTF8));
        pushButton_mail->setText(QApplication::translate("ui_new_compra_flete", "Mail", 0, QApplication::UnicodeUTF8));
        pushButton_imprimir->setText(QApplication::translate("ui_new_compra_flete", "Imprimir", 0, QApplication::UnicodeUTF8));
        pushButton_cancelar->setText(QApplication::translate("ui_new_compra_flete", "Cancelar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class ui_new_compra_flete: public Ui_ui_new_compra_flete {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UI_NEW_COMPRA_FLETE_H
