...
#include "ui_ui_new_compra_factura.h"

#include "share_include.h"
#include <QMessageBox>
ui_new_compra_factura::ui_new_compra_factura(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ui_new_compra_factura)
{
    ui->setupUi(this);
...
ui_new_compra_factura::~ui_new_compra_factura()
{
    delete ui;
}

void ui_new_compra_factura::on_pushButton_buscarProveedor_clicked()
{

}

void ui_new_compra_factura::on_pushButton_buscarTransportista_clicked()
{

}

void ui_new_compra_factura::on_pushButton_ingresarArticulos_clicked()
{

}

// Son para mismo boton los siguientes 2 metodos slot
void ui_new_compra_factura::on_pushButton_registrar_clicked()
{
...
void ui_new_compra_factura::on_pushButton_editar_clicked()
{
...
void ui_new_compra_factura::on_pushButton_cancelar_clicked()
{
    this->close();
}
