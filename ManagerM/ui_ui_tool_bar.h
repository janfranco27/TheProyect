...
public:
    ...
    void setupUi(QWidget *ui_tool_bar)
    {
        ...
        pushButton_home = new QPushButton(ui_tool_bar);
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/Iconos/Iconos/Home.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_home->setIcon(icon);
        pushButton_home->setIconSize(QSize(30, 30));
        ...
        label_7 = new QLabel(ui_tool_bar);
        ...
        pushButton_ventas = new QPushButton(ui_tool_bar);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/Iconos/Iconos/JAVA.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_ventas->setIcon(icon1);
        pushButton_ventas->setIconSize(QSize(30, 30));
        ...
        label_2 = new QLabel(ui_tool_bar);
        ...
        pushButton_compras = new QPushButton(ui_tool_bar);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/Iconos/Iconos/Stack.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_compras->setIcon(icon2);
        pushButton_compras->setIconSize(QSize(30, 30));
        ...
        label_9 = new QLabel(ui_tool_bar);
        ...
        pushButton_articulos = new QPushButton(ui_tool_bar);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/Iconos/Iconos/16.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_articulos->setIcon(icon3);
        pushButton_articulos->setIconSize(QSize(30, 30));
        ...
        label_10 = new QLabel(ui_tool_bar);
        ...
        pushButton_colaborador = new QPushButton(ui_tool_bar);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/Iconos/Iconos/Account and Control.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_colaborador->setIcon(icon4);
        pushButton_colaborador->setIconSize(QSize(30, 30));
        ...
        label_11 = new QLabel(ui_tool_bar);
        ...
        pushButton_cliente = new QPushButton(ui_tool_bar);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/Iconos/Iconos/People-MSN.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        label_12 = new QLabel(ui_tool_bar);
        ...
        pushButton_opciones = new QPushButton(ui_tool_bar);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/Iconos/Iconos/Gear.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_opciones->setIcon(icon6);
        pushButton_opciones->setIconSize(QSize(30, 30));
        ...
        label_13 = new QLabel(ui_tool_bar);
