...
public:
    ...
    void setupUi(QTabWidget *ui_opciones_articulo)
    {
        ...
        ui_opciones_articulo->setMinimumSize(QSize(0, 408));
        tab_3 = new QWidget();
        ...
        ui_opciones_articulo->addTab(tab_3, QString());
        tab_2 = new QWidget();
        ...
        tableView_medida = new QTableView(tab_2);
        ...
        lineEdit_medida = new QLineEdit(tab_2);
        ...
        pushButton_save_medida = new QPushButton(tab_2);
        ...
        pushButton_delete_medida = new QPushButton(tab_2);
        ...
        ui_opciones_articulo->addTab(tab_2, QString());
        tab = new QWidget();
        ...
        tableView_grupo = new QTableView(tab);
        ...
        lineEdit_grupo = new QLineEdit(tab);
        ...
        pushButton_save_grupo = new QPushButton(tab);
        ...
        pushButton_delete_grupo = new QPushButton(tab);
        ...
        ui_opciones_articulo->addTab(tab, QString());
    ...
    void retranslateUi(QTabWidget *ui_opciones_articulo)
    {
        ...
        ui_opciones_articulo->setTabText(ui_opciones_articulo->indexOf(tab), QApplication::translate("ui_opciones_articulo", "Grupos", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
