/********************************************************************************
** Form generated from reading UI file 'ui_new_factura_compra.ui'
**
** Created: Wed 15. May 15:57:50 2013
**      by: Qt User Interface Compiler version 4.8.1
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_UI_NEW_FACTURA_COMPRA_H
#define UI_UI_NEW_FACTURA_COMPRA_H
...
class Ui_ui_new_factura_compra
{
public:
    ...
    void setupUi(QWidget *ui_new_factura_compra)
    {
        if (ui_new_factura_compra->objectName().isEmpty())
            ui_new_factura_compra->setObjectName(QString::fromUtf8("ui_new_factura_compra"));
        ui_new_factura_compra->resize(660, 475);
        gridLayout_2 = new QGridLayout(ui_new_factura_compra);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        verticalLayout = new QVBoxLayout();
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        horizontalLayout_8 = new QHBoxLayout();
        horizontalLayout_8->setObjectName(QString::fromUtf8("horizontalLayout_8"));
        label_codigo = new QLabel(ui_new_factura_compra);
        ...
        lineEdit_codigo = new QLineEdit(ui_new_factura_compra);
        ...
        label_fecha_emision = new QLabel(ui_new_factura_compra);
        ...
        dateEdit_emision = new QDateEdit(ui_new_factura_compra);
        ...
        label_fecha_sistema = new QLabel(ui_new_factura_compra);
        ...
        dateEdit_sistema = new QDateEdit(ui_new_factura_compra);
        ...
        label_serie_numero = new QLabel(ui_new_factura_compra);
        ...
        lineEdit_serie = new QLineEdit(ui_new_factura_compra);
        ...
        label_menos = new QLabel(ui_new_factura_compra);
        label_menos->setObjectName(QString::fromUtf8("label_menos"));

        horizontalLayout_7->addWidget(label_menos);

        lineEdit_numero = new QLineEdit(ui_new_factura_compra);
        ...
        label_proveedor = new QLabel(ui_new_factura_compra);
        ...
        lineEdit_codigoProveedor = new QLineEdit(ui_new_factura_compra);
        ...
        line_2 = new QFrame(ui_new_factura_compra);
        ...
        lineEdit_nombreProveedor = new QLineEdit(ui_new_factura_compra);
        ...
        pushButton_buscarProveedor = new QPushButton(ui_new_factura_compra);
        ...
        label_moneda = new QLabel(ui_new_factura_compra);
        ...
        comboBox_moneda = new QComboBox(ui_new_factura_compra);
        ...
        label_modalidad = new QLabel(ui_new_factura_compra);
        ...
        comboBox_modalidad = new QComboBox(ui_new_factura_compra);
        ...
        label_percepcion = new QLabel(ui_new_factura_compra);
        ...
        line = new QFrame(ui_new_factura_compra);
        ...
        pushButton_ingresarArticulos = new QPushButton(ui_new_factura_compra);
        ...
        tableView_articulos = new QTableView(ui_new_factura_compra);
        ...
        retranslateUi(ui_new_factura_compra);

        QMetaObject::connectSlotsByName(ui_new_factura_compra);
    } // setupUi

    void retranslateUi(QWidget *ui_new_factura_compra)
    {
        ui_new_factura_compra->setWindowTitle(QApplication::translate("ui_new_factura_compra", "Form", 0, QApplication::UnicodeUTF8));
        label_codigo->setText(QApplication::translate("ui_new_factura_compra", "C\303\263digo:", 0, QApplication::UnicodeUTF8));
        lineEdit_codigo->setInputMask(QString());
        label_fecha_emision->setText(QApplication::translate("ui_new_factura_compra", "Fecha de emisi\303\263n:", 0, QApplication::UnicodeUTF8));
        label_fecha_sistema->setText(QApplication::translate("ui_new_factura_compra", "Fecha de sistema:", 0, QApplication::UnicodeUTF8));
        label_serie_numero->setText(QApplication::translate("ui_new_factura_compra", "Serie y n\303\272mero:", 0, QApplication::UnicodeUTF8));
        lineEdit_serie->setInputMask(QString());
        label_menos->setText(QApplication::translate("ui_new_factura_compra", "-", 0, QApplication::UnicodeUTF8));
        lineEdit_numero->setInputMask(QString());
        label_proveedor->setText(QApplication::translate("ui_new_factura_compra", "Proveedor:", 0, QApplication::UnicodeUTF8));
        lineEdit_codigoProveedor->setInputMask(QString());
        pushButton_buscarProveedor->setText(QApplication::translate("ui_new_factura_compra", "Buscar", 0, QApplication::UnicodeUTF8));
        label_moneda->setText(QApplication::translate("ui_new_factura_compra", "Tipo de moneda:", 0, QApplication::UnicodeUTF8));
        comboBox_moneda->clear();
        comboBox_moneda->insertItems(0, QStringList()
         << QApplication::translate("ui_new_factura_compra", "SOLES", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ui_new_factura_compra", "DOLARES", 0, QApplication::UnicodeUTF8)
        );
        label_modalidad->setText(QApplication::translate("ui_new_factura_compra", "Modalidad:", 0, QApplication::UnicodeUTF8));
        comboBox_modalidad->clear();
        comboBox_modalidad->insertItems(0, QStringList()
         << QApplication::translate("ui_new_factura_compra", "CON IGV", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ui_new_factura_compra", "SIN IGV", 0, QApplication::UnicodeUTF8)
        );
        label_percepcion->setText(QApplication::translate("ui_new_factura_compra", "Percepci\303\263n:", 0, QApplication::UnicodeUTF8));
        comboBox_percepcion->clear();
        comboBox_percepcion->insertItems(0, QStringList()
         << QApplication::translate("ui_new_factura_compra", "No", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("ui_new_factura_compra", "Si", 0, QApplication::UnicodeUTF8)
        );
        lineEdit_numeroPercepcion->setInputMask(QString());
        pushButton_ingresarArticulos->setText(QApplication::translate("ui_new_factura_compra", "Ingresar art\303\255culos", 0, QApplication::UnicodeUTF8));
        label_subtotal->setText(QApplication::translate("ui_new_factura_compra", "Sub Total:", 0, QApplication::UnicodeUTF8));
        label_igv->setText(QApplication::translate("ui_new_factura_compra", "IGV:", 0, QApplication::UnicodeUTF8));
        label_total->setText(QApplication::translate("ui_new_factura_compra", "Total:", 0, QApplication::UnicodeUTF8));
        lineEdit_igv->setText(QApplication::translate("ui_new_factura_compra", "0.18", 0, QApplication::UnicodeUTF8));
        pushButton_registrar->setText(QApplication::translate("ui_new_factura_compra", "Registrar", 0, QApplication::UnicodeUTF8));
        pushButton_mail->setText(QApplication::translate("ui_new_factura_compra", "Mail", 0, QApplication::UnicodeUTF8));
        pushButton_imprimir->setText(QApplication::translate("ui_new_factura_compra", "Imprimir", 0, QApplication::UnicodeUTF8));
        pushButton_cancelar->setText(QApplication::translate("ui_new_factura_compra", "Cancelar", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class ui_new_factura_compra: public Ui_ui_new_factura_compra {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_UI_NEW_FACTURA_COMPRA_H
