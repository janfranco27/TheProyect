...
#include "ui_ui_new_flete.h"

#include "share_include.h"
#include <QMessageBox>
ui_new_flete::ui_new_flete(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ui_new_flete)
{
    ui->setupUi(this);
...
ui_new_flete::~ui_new_flete()
{
    delete ui;
}

void ui_new_flete::setType(int mode)
{
    if(mode == COMPRAS_NEW)
    {
...
void ui_new_flete::on_pushButton_buscarTransportista_clicked()
{

}
void ui_new_flete::on_pushButton_registrar_clicked()
{
...
void ui_new_flete::on_pushButton_editar_clicked()
{
...
void ui_new_flete::on_pushButton_cancelar_clicked()
{
    this->close();
}
