...
public:
	object_e_articulo();
	object_e_articulo(_QSTR pk_articulo, _QSTR fk_grupo, _QSTR fk_marca, _QSTR fk_medida, _QSTR descripcion, _QSTR precio_lista, _QSTR stock);
	object_e_articulo(_QSTR fk_grupo, _QSTR fk_marca, _QSTR fk_medida, _QSTR descripcion, _QSTR precio_lista, _QSTR stock);
