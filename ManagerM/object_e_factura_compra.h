...
public:
	...
	object_e_factura_compra(_QSTR pk_factura_compra, _QSTR fk_comprobante, _QSTR fk_tipo_pago, _QSTR fk_proveedor, _QSTR fk_factura_transportista, _QSTR total, _QSTR igv);
	object_e_factura_compra(_QSTR fk_comprobante, _QSTR fk_tipo_pago, _QSTR fk_proveedor, _QSTR fk_factura_transportista, _QSTR total, _QSTR igv);
