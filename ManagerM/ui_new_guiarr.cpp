...
#include "ui_ui_new_guiarr.h"

#include "share_include.h"
#include <QMessageBox>

ui_new_guiarr::ui_new_guiarr(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::ui_new_guiarr)
{
    ui->setupUi(this);
...
ui_new_guiarr::~ui_new_guiarr()
{
    delete ui;
}

void ui_new_guiarr::setType(int mode)
{
    if(mode == COMPRAS_NEW)
    {
...
void ui_new_guiarr::on_pushButton_buscarProveedor_clicked()
{

}

void ui_new_guiarr::on_pushButton_buscarTransportista_clicked()
{

}

void ui_new_guiarr::on_pushButton_ingresarArticulos_clicked()
{

}

// Son para mismo boton los siguientes 2 metodos slot
void ui_new_guiarr::on_pushButton_registrar_clicked()
{
...
void ui_new_guiarr::on_pushButton_editar_clicked()
{
...
void ui_new_guiarr::on_pushButton_cancelar_clicked()
{
    this->close();
}
